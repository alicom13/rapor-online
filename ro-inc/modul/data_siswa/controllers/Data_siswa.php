...
class Data_siswa extends CI_Controller {
    ...
    public function edit($id) {
        ...
        $this->d['p_jk']  = array(""=>"Jenis Kelamin","L"=>"Laki-laki","P"=>"Perempuan");
    ...
    public function simpan() {
        ...
        //upload config 
        $config['upload_path']      = './ro-web/upload/foto_siswa';
    ...
    public function import_siswa() {
        $target_file = './ro-web/upload/temp/';
        ...
        if($file[$length -1] == 'xlsx' || $file[$length -1] == 'xls') {
            ...
            $tmp    = './ro-web/upload/temp/import_siswa.xls';
            ...
            @unlink('./ro-web/upload/temp/import_siswa.xls');
